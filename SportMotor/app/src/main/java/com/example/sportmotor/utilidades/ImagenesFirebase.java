package com.example.sportmotor.utilidades;
...
public class ImagenesFirebase {
    ...
    public void subirFoto(final ImagenesFirebase.FotoStatus fotoStatus, String email, String nbastidor, ImageView img_add_foto) {
        ...
        StorageReference foto2Ref = storageRef.child(email+"/"+String.valueOf(nbastidor)+".png");
